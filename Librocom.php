...
<body>
        ...
        <div class="comments-container">
            ...
            <ul id="comments-list" class="comments-list">
                <li>
                    <div class="comment-main-level">
                        <div class="comment-avatar">
                            <img src="imagenes/Gustavo.jpg"></div>
                        <div class="comment-box">
                            <div class="comment-head">
                                <h6 class="comment-name by-author"><a href="#">Gustavo9823</a></h6>
                ...
                <li>
                    <div class="comment-main-level">
                        <div class="comment-avatar">
                            <img src="imagenes/cristina.jpg"></div>
                        <div class="comment-box">
                            <div class="comment-head">
                                <h6 class="comment-name by-author"><a href="#">CristinaGN23</a></h6>
                ...
                <li>
                    <div class="comment-main-level">
                        ...
                        <div class="comment-box">
                            <div class="comment-head">
                                <h6 class="comment-name by-author"><a href="#">Ruben765</a></h6>
                ...
                <li>
                    <div class="comment-main-level">
                        ...
                        <div class="comment-box">
                            <div class="comment-head">
                                <h6 class="comment-name by-author"><a href="#">VictoriaNT</a></h6>
                ...
                <li>
                    <div class="comment-main-level">
                        ...
                        <div class="comment-box">
                            <div class="comment-head">
                                <h6 class="comment-name by-author"><a href="#">Carlos3Ro</a></h6>
    ...
    <section class="paginacion">
        <ul>
            <li><a href="Librocom.php" class="active">1</a></li>
