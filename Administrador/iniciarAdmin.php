...
<body>
    ...
    <div class="header">
        <h1 class="logo">Phone-Market</h2>
            ...
            <ul class="menu">
                <a href="../index.php"><span class="icon-home"></span> Ir a Tienda</a>
    ...
    <main>
        <h2>Administrador-Iniciar Sesi&oacute;n</h2>
        <form name=form action="validarAdmin.php" target="" method="POST">
